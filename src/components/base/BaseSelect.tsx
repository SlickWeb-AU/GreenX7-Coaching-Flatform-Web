    ...
    <div ref={containerRef} className={cn('relative w-full', className)}>
      ...
      {isOpen && (
        <div
          id={listboxId}
          role="listbox"
          className="absolute left-0 top-full z-50 mt-1.5 max-h-80 w-full animate-fade-in overflow-y-auto rounded-xl border border-neutral-grey-5 bg-white p-1 text-neutral-grey-1 shadow-lg shadow-black/5"
        >
          {options.map((opt) => {
